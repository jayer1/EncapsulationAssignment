...
public class Employee {
    ...
    public void correctOrder(String cubeId) {
    ...
    private String setFormatOrientationDate(Date orientationDate) {
    ...
    private void displayHRMeetUp() {
        String formatDate = setFormatOrientationDate(orientationDate);
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        displayDeptStaffMeetUp();

    }

    private void displayDeptStaffMeetUp() {
        String formatDate = setFormatOrientationDate(orientationDate);
    ...
    public void reviewDeptPolicies() {
        ...
        displayPolicyReviewMeetUp();

    }

    private void displayPolicyReviewMeetUp() {
        String formatDate = setFormatOrientationDate(orientationDate);
    ...
    public void moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        displayMoveInCubicle();

    }

    public void displayMoveInCubicle() {
        String formatDate = setFormatOrientationDate(orientationDate);
