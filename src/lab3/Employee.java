...
public class Employee {
    ...
    private void meetWithHrForBenefitAndSalryInfo() {
        metWithHr = true;
        String message = firstName + " " + lastName + " met with Hr on "
                + getFormattedDate();
        rp.printMessage(message);
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        String message = firstName + " " + lastName + " met with Dept. Staff on "
                + getFormattedDate();
        rp.printMessage(message);
    }
    ...
    public void reviewDeptPolicies() {
        ...
        String message = firstName + " " + lastName + " reviewed Dept policies on "
                + getFormattedDate();
        rp.printMessage(message);
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        String message = firstName + " " + lastName + " moved into cubicle "
